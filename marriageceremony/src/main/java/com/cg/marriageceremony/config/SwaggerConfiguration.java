	 ...
	 @Bean
		public Docket productApi() {
			...
			return new Docket(DocumentationType.SWAGGER_2)		
					.select().apis(RequestHandlerSelectors.basePackage("com.cg.marriageceremony.controller"))
			...
			private ApiInfo metaInfo() {
				...
				ApiInfo apiInfo = new ApiInfo(
					...
					"1.0", 
					"Terms of Service", 
					new Contact("Vivaah Application", "https://www.capgemini.com/", "@capgemini.com"), 
